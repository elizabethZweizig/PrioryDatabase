	...
	<p>
		...
		try
		{
			...
			foreach($result as $tuple)
			{
				...
				echo "<a href='./update.php?table=planes&row=$tuple[tail_no]'>Update</a>";
				echo "<a href='./delete.php?table=planes&row=$tuple[tail_no]'>Delete</a>";
			...
			foreach($result2 as $tuple2)
			{
				...
				echo "<a href='./update.php?table=flights&row=$tuple2[flight_no]'>Update</a>";
				echo "<a href='./delete.php?table=flights&row=$tuple2[flight_no]'>Delete</a>";
			...
			foreach($result3 as $tuple3)
			{
				...
				echo "<a href='./update.php?table=passengers&row=$tuple3[ssn]'>Update</a>";
				echo "<a href='./delete.php?table=passengers&row=$tuple3[ssn]'>Delete</a>";
			...
			foreach($result4 as $tuple4)
			{
				...
				echo "<a href='./update.php?table=onboard&row1=$tuple4[ssn]&row2=$tuple4[flight_no]'>Update</a>";
				echo "<a href='./delete.php?table=onboard&row1=$tuple4[ssn]&row2=$tuple4[flight_no]'>Delete</a>";
