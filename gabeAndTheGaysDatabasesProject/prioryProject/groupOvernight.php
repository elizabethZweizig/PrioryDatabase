...
<!DOCTYPE html>
<head>
  <title>Group Overnight Registration</title>
  <link rel="stylesheet" type="text/css" href="style.css">
</head>
<body>
  <div class="divclass">
    <h3>Overnight Reservation</h3>
    <form action="groupOver.php" method="post">
      ...
      How many people will be joining us?<font color="red">*</font>
      <input type="number" name="numPpl" min="1" required/><br>
